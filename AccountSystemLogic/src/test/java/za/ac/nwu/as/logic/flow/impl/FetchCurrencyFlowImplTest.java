...
////                "rudidreyer7@gmail.com", "0767869466", new Currency());
//////        Currency currency = new Currency();
//        when(memberTranslator.fetchMemberByIdPersist(1)).thenReturn(new Member());
//////        assertNotNull(member);
//        when(flow.fetchCurrencyByMemberId(1)).thenReturn(
//                new CurrencyDto(BigDecimal.valueOf(50), "MILES")
//        );
